...
(function () {
    ...
    }, x = ["find", "replace"], q = [["txtFindFind", "txtFindReplace"], ["txtFindCaseChk",
        "txtReplaceCaseChk"], ["txtFindWordChk", "txtReplaceWordChk"], ["txtFindCyclic", "txtReplaceCyclic"]];
    CKEDITOR.dialog.add("find", function (c) {
        function n(a, b) {
            var d = this, c = new CKEDITOR.dom.walker(a);
            c.guard = b ? v : function (a) {
        ...
        function r(a) {
            var b = c.getSelection().getRanges()[0], d = c.editable();
        ...
        var z = new CKEDITOR.style(CKEDITOR.tools.extend({
        ...
        var t = function (a, b) {
            this._ = {
                walker: a, cursors: [], rangeLength: b, highlightRange: null,
                isMatched: 0
            }
        };
        t.prototype = {
        ...
        var A = function (a, b) {
            ...
            this._ = {
                overlap: d,
                state: 0, ignoreCase: !!b, pattern: a
            }
        };
        A.prototype = {
        ...
        var D = /[.,"'?!;: \u0085\u00a0\u1680\u280e\u2028\u2029\u202f\u205f\u3000]/, B = function (a) {
            ...
            searchRange: null, matchRange: null, find: function (a, b, d, e, f, u) {
                    ...
                    if (2 == k) {
                        if (d) {
                            var g = this.matchRange.getCursors(),
                                p = g[g.length - 1], g = g[0], m = c.createRange();
                ...
                return e && !u ? (this.searchRange = r(1), this.matchRange = null, arguments.callee.apply(this, Array.prototype.slice.call(arguments).concat([!0]))) :
                    !1
            }, replaceCounter: 0, replace: function (a, b, d, e, f, u, h) {
                m = 1;
                a = 0;
                a = this.hasMatchOptionsChanged(b, e, f);
                if (!this.matchRange || !this.matchRange.isMatched() || this.matchRange._.isReplaced || this.matchRange.isReadOnly() || a) a && this.matchRange && (this.matchRange.clearMatched(), this.matchRange.removeHighlight(), this.matchRange = null), a = this.find(b, e, f, u, !h); else {
                    this.matchRange.removeHighlight();
                ...
                m = 0;
                return a
            }, matchOptions: null, hasMatchOptionsChanged: function (a, b, d) {
                a = [a, b, d].join(".");
        ...
        return {
            ...
            contents: [{
                ...
                id: "replace", label: e.replace, accessKey: "M", elements: [{
                    ...
                    type: "hbox", widths: ["230px", "90px"], children: [{
                        type: "text",
                        id: "txtReplace", label: e.replaceWith, isChanged: !1, labelLayout: "horizontal", accessKey: "R"
                    }, {
                        type: "button",
                        id: "btnReplaceAll",
                        align: "left",
            ...
            onShow: function () {
                f.searchRange = r();
                var a = this._.currentTabId, b = this.getParentEditor().getSelection().getSelectedText(),
            ...
            onFocus: function () {
                return "replace" == this._.currentTabId ? this.getContentElement("replace", "txtFindReplace") : this.getContentElement("find", "txtFindFind")
            }
        }
    })
})();